...
class MoonrakerClient:
    ...
    def exclude_current_object(self) -> dict[str, Any]:
        return self.run_gcode_script("EXCLUDE_OBJECT CURRENT=1")
...
def _query_fields_for_object(name: str) -> str:
    ...
    if name.startswith("temperature_fan "):
        return "temperature,target,speed,rpm"
    if name == "fan" or name.startswith(("fan_generic ", "controller_fan ", "heater_fan ")):
        return "speed,rpm"
